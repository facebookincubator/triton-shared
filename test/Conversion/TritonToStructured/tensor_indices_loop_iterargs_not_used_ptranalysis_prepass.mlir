...
// CHECK-DAG:       [[VAR_2_:%.+]]:8 = scf.for [[VAR_arg1_:%.+]] = [[CST_0_]] to [[CST_2_]] step [[CST_1_]] iter_args([[VAR_arg2_:%.+]] = [[structured_]], [[VAR_arg3_:%.+]] = [[offsets_]], [[VAR_arg4_:%.+]] = [[VAR_strides_]], [[VAR_arg5_:%.+]] = [[VAR_src_]], [[VAR_arg6_:%.+]] = [[structured_]], [[VAR_arg7_:%.+]] = [[offsets_]], [[VAR_arg8_:%.+]] = [[VAR_strides_]], [[VAR_arg9_:%.+]] = [[VAR_src_]]) -> (tensor<4xi32>, index, index, !tt.ptr<none>, tensor<4xi32>, index, index, !tt.ptr<none>)  : i32 {
// CHECK-DAG:         [[VAR_3_:%.+]] = tt.addptr [[VAR_1_]], [[VAR_arg2_]] : tensor<4x!tt.ptr<f32>>, tensor<4xi32>
// CHECK-DAG:         [[VAR_4_:%.+]] = arith.sitofp [[VAR_arg6_]] : tensor<4xi32> to tensor<4xf32>
// CHECK:             tt.store [[VAR_3_]], [[VAR_4_]] : tensor<4x!tt.ptr<f32>>
// CHECK-DAG:         [[VAR_5_:%.+]] = arith.addi [[VAR_arg2_]], [[VAR_cst_]] : tensor<4xi32>
// CHECK-DAG:         [[VAR_6_:%.+]] = arith.addi [[VAR_arg6_]], [[VAR_cst_]] : tensor<4xi32>
// CHECK-DAG:         [[structured_3_:%.+]], [[offsets_4_:%.+]], [[VAR_strides_5_:%.+]], [[VAR_src_9_:%.+]] = "tts.get_structured_state"([[VAR_5_]]) <{resultSegmentSizes = array<i32: 1, 1, 1, 1>}> : (tensor<4xi32>) -> (tensor<4xi32>, index, index, !tt.ptr<none>)
// CHECK-DAG:         [[structured_6_:%.+]], [[offsets_7_:%.+]], [[VAR_strides_8_:%.+]], [[VAR_src_10_:%.+]] = "tts.get_structured_state"([[VAR_6_]]) <{resultSegmentSizes = array<i32: 1, 1, 1, 1>}> : (tensor<4xi32>) -> (tensor<4xi32>, index, index, !tt.ptr<none>)
// CHECK:             scf.yield [[structured_3_]], [[offsets_4_]], [[VAR_strides_5_]], [[VAR_src_9_]], [[structured_6_]], [[offsets_7_]], [[VAR_strides_8_]], [[VAR_src_10_]] : tensor<4xi32>, index, index, !tt.ptr<none>, tensor<4xi32>, index, index, !tt.ptr<none>
// CHECK:           }
// CHECK:           tt.return
// CHECK:         }
