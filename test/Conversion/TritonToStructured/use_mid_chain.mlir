...
// CHECK-DAG:       [[VAR_3_:%.+]] = tts.make_tptr [[arg1_]] to sizes: [256, 128], strides: [1, 6], offsets: [512, 6144{{.}}, shape: [0, 0], order: [] : <bf16> to tensor<256x128x!tt.ptr<bf16>>
...
// CHECK:           [[VAR_5_:%.+]] = tts.make_tptr [[arg2_]] to sizes: [256, 128], strides: [1, 6], offsets: [512, 6144{{.}}, shape: [0, 0], order: [] : <i32> to tensor<256x128x!tt.ptr<i32>>
