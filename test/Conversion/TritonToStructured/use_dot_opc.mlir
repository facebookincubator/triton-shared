...
// CHECK-DAG:       [[VAR_2_:%.+]] = tts.make_tptr [[PARAM_1_]] to sizes: [64, 256], strides: [256, 1], offsets: [0, 0], shape: [0, 0], order: [] : <bf16> to tensor<64x256x!tt.ptr<bf16>>
...
// CHECK-DAG:       [[VAR_4_:%.+]] = tts.make_tptr [[PARAM_2_]] to sizes: [128, 256], strides: [256, 1], offsets: [0, 0], shape: [0, 0], order: [] : <bf16> to tensor<128x256x!tt.ptr<bf16>>
