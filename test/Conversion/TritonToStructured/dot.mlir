...
// CHECK:           [[VAR_0_:%.+]] = tts.make_tptr [[PARAM_0_]] to sizes: [128, 64], strides: {{.}}128, 1], offsets: [0, 0], shape: [0, 0], order: [] : <bf16> to tensor<128x64x!tt.ptr<bf16>>
...
// CHECK-DAG:       [[VAR_2_:%.+]] = tts.make_tptr [[PARAM_1_]] to sizes: [256, 64], strides: [1, 256{{.}}, offsets: [0, 0], shape: [0, 0], order: [] : <bf16> to tensor<256x64x!tt.ptr<bf16>>
...
// CHECK-DAG:       [[VAR_5_:%.+]] = tts.make_tptr [[PARAM_2_]] to sizes: [128, 256], strides: {{.}}256, 1], offsets: [0, 0], shape: [0, 0], order: [] : <bf16> to tensor<128x256x!tt.ptr<bf16>>
