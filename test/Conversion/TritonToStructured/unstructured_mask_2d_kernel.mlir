...
// CHECK:           %[[VAL_29:.*]] = tts.make_gather_scatter_tptr %[[VAL_0]] to sizes: [8, 16] gather_scatter_dim: 0 gather_scatter_offset: %[[VAL_28]] gather_scatter_mask: %[[VAL_19]], strides: [16, 1], offsets: [0, 0] : tensor<8xi32> tensor<8xi1> <f32> to tensor<8x16x!tt.ptr<f32>>
...
// CHECK:           %[[VAL_33:.*]] = tts.make_gather_scatter_tptr %[[VAL_1]] to sizes: [8, 16] gather_scatter_dim: 1 gather_scatter_offset: %[[VAL_32]] gather_scatter_mask: %[[VAL_26]], strides: [16, 1], offsets: [0, 0] : tensor<16xi32> tensor<16xi1> <f32> to tensor<8x16x!tt.ptr<f32>>
