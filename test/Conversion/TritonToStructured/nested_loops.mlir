...
// CHECK-DAG:           [[VAR_15_:%.+]] = tts.make_tptr [[arg1_]] to sizes: [2, 2], strides: {{.}}[[VAR_2_]], [[VAR_3_]]{{.}}, offsets: {{.}}[[VAR_arg9_]], 0], shape: [0, 0], order: [] : <f32> to tensor<2x2x!tt.ptr<f32>>
// CHECK-DAG:           [[VAR_16_:%.+]] = tts.make_tptr [[arg0_]] to sizes: [2, 2], strides: {{.}}[[VAR_0_]], [[VAR_1_]]{{.}}, offsets: {{.}}[[VAR_arg8_]], 0], shape: [0, 0], order: [] : <f32> to tensor<2x2x!tt.ptr<f32>>
...
// CHECK-DAG:         [[VAR_10_1_:%.+]] = tts.make_tptr [[arg1_]] to sizes: [2, 2], strides: {{.}}[[VAR_2_1_]], [[VAR_3_1_]]{{.}}, offsets: {{.}}[[VAR_arg6_1_]], 0], shape: [0, 0], order: [] : <f32> to tensor<2x2x!tt.ptr<f32>>
// CHECK-DAG:         [[VAR_11_1_:%.+]] = tts.make_tptr [[arg0_]] to sizes: [2, 2], strides: {{.}}[[VAR_0_1_]], [[VAR_1_1_]]{{.}}, offsets: {{.}}[[VAR_arg5_1_]], 0], shape: [0, 0], order: [] : <f32> to tensor<2x2x!tt.ptr<f32>>
...
// CHECK-DAG:           [[VAR_16_1_:%.+]] = tts.make_tptr [[arg1_]] to sizes: [2, 2], strides: {{.}}[[VAR_2_1_]], [[VAR_3_1_]]{{.}}, offsets: {{.}}[[VAR_arg9_1_]], 0], shape: [0, 0], order: [] : <f32> to tensor<2x2x!tt.ptr<f32>>
// CHECK-DAG:           [[VAR_17_1_:%.+]] = tts.make_tptr [[arg0_]] to sizes: [2, 2], strides: {{.}}[[VAR_0_1_]], [[VAR_1_1_]]{{.}}, offsets: {{.}}[[VAR_arg8_1_]], 0], shape: [0, 0], order: [] : <f32> to tensor<2x2x!tt.ptr<f32>>
...
// CHECK-DAG:         [[VAR_13_2_:%.+]] = tts.make_tptr [[arg0_]] to sizes: [2, 2], strides: {{.}}[[VAR_0_2_]], [[VAR_1_2_]]{{.}}, offsets: {{.}}[[VAR_arg5_2_]], 0], shape: [0, 0], order: [] : <f32> to tensor<2x2x!tt.ptr<f32>>
// CHECK-NOT: separator of consecutive DAGs
...
// CHECK:               [[VAR_18_2_:%.+]] = tts.make_tptr [[arg0_]] to sizes: [2, 2], strides: {{.}}[[VAR_0_2_]], [[VAR_1_2_]]{{.}}, offsets: {{.}}[[VAR_17_2_]], 0], shape: [0, 0], order: [] : <f32> to tensor<2x2x!tt.ptr<f32>>
...
// CHECK-DAG:             [[VAR_21_:%.+]] = tts.make_tptr [[arg1_]] to sizes: [2, 2], strides: {{.}}[[VAR_2_2_]], [[VAR_3_2_]]{{.}}, offsets: {{.}}[[VAR_arg12_]], 0], shape: [0, 0], order: [] : <f32> to tensor<2x2x!tt.ptr<f32>>
// CHECK-DAG:             [[VAR_22_:%.+]] = arith.addi [[VAR_arg11_]], [[VAR_8_2_]] : index
// CHECK:                 [[VAR_23_:%.+]] = tts.make_tptr [[arg0_]] to sizes: [2, 2], strides: {{.}}[[VAR_0_2_]], [[VAR_1_2_]]{{.}}, offsets: {{.}}[[VAR_22_]], 0], shape: [0, 0], order: [] : <f32> to tensor<2x2x!tt.ptr<f32>>
...
// CHECK:                 [[VAR_26_:%.+]] = tts.make_tptr [[arg1_]] to sizes: [2, 2], strides: {{.}}[[VAR_2_2_]], [[VAR_3_2_]]{{.}}, offsets: {{.}}[[VAR_25_]], 0], shape: [0, 0], order: [] : <f32> to tensor<2x2x!tt.ptr<f32>>
...
// CHECK:                 [[VAR_28_:%.+]] = tts.make_tptr [[arg1_]] to sizes: [2, 2], strides: {{.}}[[VAR_2_2_]], [[VAR_3_2_]]{{.}}, offsets: {{.}}[[VAR_27_]], 0], shape: [0, 0], order: [] : <f32> to tensor<2x2x!tt.ptr<f32>>
...
// CHECK-DAG:           [[VAR_18_4_:%.+]] = tts.make_tptr [[arg1_]] to sizes: [2, 2], strides: {{.}}[[VAR_2_3_]], [[VAR_3_3_]]{{.}}, offsets: {{.}}[[VAR_arg9_3_]], 0], shape: [0, 0], order: [] : <f32> to tensor<2x2x!tt.ptr<f32>>
// CHECK-DAG:           [[VAR_19_3_:%.+]] = tts.make_tptr [[arg0_]] to sizes: [2, 2], strides: {{.}}[[VAR_0_3_]], [[VAR_1_3_]]{{.}}, offsets: {{.}}[[VAR_arg8_4_]], 0], shape: [0, 0], order: [] : <f32> to tensor<2x2x!tt.ptr<f32>>
// CHECK-NOT: separator of consecutive DAGs
...
// CHECK:               [[VAR_22_1_:%.+]] = tts.make_tptr [[arg0_]] to sizes: [2, 2], strides: {{.}}[[VAR_0_3_]], [[VAR_1_3_]]{{.}}, offsets: {{.}}[[VAR_21_1_]], 0], shape: [0, 0], order: [] : <f32> to tensor<2x2x!tt.ptr<f32>>
...
// CHECK:               [[VAR_26_1_:%.+]] = tts.make_tptr [[arg1_]] to sizes: [2, 2], strides: {{.}}[[VAR_2_3_]], [[VAR_3_3_]]{{.}}, offsets: {{.}}[[VAR_25_1_]], 0], shape: [0, 0], order: [] : <f32> to tensor<2x2x!tt.ptr<f32>>
