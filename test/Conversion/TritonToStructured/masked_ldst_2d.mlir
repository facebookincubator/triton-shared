...
// CHECK-DAG:       [[VAR_0_:%.+]] = tts.make_tptr [[PARAM_0_]] to sizes: [128, 256], strides: [1, 1024], offsets: [2, 3072], shape: [0, 0], order: [] : <bf16> to tensor<128x256x!tt.ptr<bf16>>
// CHECK-DAG:       [[VAR_1_:%.+]] = tts.make_tptr [[PARAM_1_]] to sizes: [128, 256], strides: [1, 1024], offsets: [2, 3072], shape: [0, 0], order: [] : <bf16> to tensor<128x256x!tt.ptr<bf16>>
