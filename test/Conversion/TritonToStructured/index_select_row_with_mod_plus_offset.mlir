...
// CHECK:           %[[VAL_17:.*]] = tts.make_gather_scatter_tptr %[[VAL_0]] to sizes: [4, 16] gather_scatter_dim: 0 gather_scatter_offset: %[[VAL_15]], strides: {{\[}}%[[VAL_16]], 1], offsets: [0, 0] : tensor<4xi32> <f32> to tensor<4x16x!tt.ptr<f32>>
// CHECK:           %[[VAL_18:.*]] = "tts.load"(%[[VAL_17]]) <{operandSegmentSizes = array<i32: 1, 0, 0>, static_mask_dims = array<i64>}> : (tensor<4x16x!tt.ptr<f32>>) -> tensor<4x16xf32>
