...
// CHECK-NOT: separator of consecutive DAGs
// CHECK-DAG:       [[VAR_reinterpret_cast_0_:%.+]] = memref.reinterpret_cast [[PARAM_0__MEMREF]] to offset: {{.}}[[VAR_2_]]{{.}}, sizes: [4, 256], strides: [2, 10] : memref<1xbf16> to memref<4x256xbf16, strided<[2, 10], offset: ?>>
...
// CHECK-DAG:           [[VAR_reinterpret_cast_2_:%.+]] = memref.reinterpret_cast [[PARAM_0__MEMREF]] to offset: {{.}}[[VAR_5_]]{{.}}, sizes: [4, 256], strides: [3, 15] : memref<1xbf16> to memref<4x256xbf16, strided<[3, 15], offset: ?>>
