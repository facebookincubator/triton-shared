...
// CHECK-DAG:       [[VAR_reinterpret_cast_:%.+]] = memref.reinterpret_cast [[PARAM_0__MEMREF]] to offset: [0], sizes: [1024], strides: [1] : memref<1xi1> to memref<1024xi1, strided<[1]>>
...
// CHECK-DAG:       [[VAR_reinterpret_cast_1_:%.+]] = memref.reinterpret_cast [[PARAM_2__MEMREF]] to offset: [0], sizes: [1024], strides: [1] : memref<1xf32> to memref<1024xf32, strided<[1]>>
