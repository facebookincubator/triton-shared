...
// CHECK:           } -> tensor<8xi32>
// CHECK-DAG:       [[VAR_reinterpret_cast_:%.+]] = memref.reinterpret_cast [[PARAM_0__MEMREF]] to offset: [0], sizes: [8], strides: [1] : memref<1xi32> to memref<8xi32, strided<[1]>>
...
// CHECK-DAG:       [[VAR_reinterpret_cast_0_:%.+]] = memref.reinterpret_cast [[PARAM_1__MEMREF]] to offset: [0], sizes: [8], strides: [1] : memref<1xi32> to memref<8xi32, strided<[1]>>
