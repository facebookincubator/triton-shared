...
// CHECK-DAG:       [[PARAM_2__TTPTR:%.+]] = tptr.from_ptr [[PARAM_2_]] : <#ptr.generic_space> -> memref<1xi32, #ptr.generic_space>
// CHECK-DAG:       [[PARAM_2__MEMREF:%.+]] = memref.memory_space_cast [[PARAM_2__TTPTR]] : memref<1xi32, #ptr.generic_space> to memref<1xi32>
...
// CHECK-DAG:           [[VAR_reinterpret_cast_0_:%.+]] = memref.reinterpret_cast [[PARAM_2__MEMREF]] to offset: [6656], sizes: [256, 128], strides: [1, 6] : memref<1xi32> to memref<256x128xi32, strided<[1, 6], offset: 6656>>
