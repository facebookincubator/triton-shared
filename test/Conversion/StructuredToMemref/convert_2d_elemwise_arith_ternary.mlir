...
// CHECK-DAG:       [[PARAM_0__TTPTR:%.+]] = tptr.from_ptr [[PARAM_0_]] : <#ptr.generic_space> -> memref<1xi1, #ptr.generic_space>
// CHECK-DAG:       [[PARAM_0__MEMREF:%.+]] = memref.memory_space_cast [[PARAM_0__TTPTR]] : memref<1xi1, #ptr.generic_space> to memref<1xi1>
...
// CHECK-DAG:           [[VAR_cast_:%.+]] = memref.reinterpret_cast [[PARAM_3__MEMREF]] to offset: [0], sizes: [1], strides: [1] : memref<1xf32> to memref<?xf32>
...
// CHECK-DAG:       [[VAR_reinterpret_cast_:%.+]] = memref.reinterpret_cast [[PARAM_0__MEMREF]] to offset: [0], sizes: [128, 128], strides: [1, 1] : memref<1xi1> to memref<128x128xi1, strided<[1, 1]>>
...
// CHECK-DAG:       [[VAR_reinterpret_cast_1_:%.+]] = memref.reinterpret_cast [[PARAM_2__MEMREF]] to offset: [0], sizes: [128, 128], strides: [1, 1] : memref<1xf32> to memref<128x128xf32, strided<[1, 1]>>
