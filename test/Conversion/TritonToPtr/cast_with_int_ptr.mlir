...
// CHECK:           %[[PTR_ADD_5:.*]] = ptr.ptr_add %[[PTR_ADD_4]], %[[MULI_4]] : !ptr.ptr<#ptr.generic_space>, i64
// CHECK:           %[[TYPE_OFFSET_3:.*]] = ptr.type_offset i64 : i32
// CHECK:           %[[MULI_5:.*]] = arith.muli %[[TYPE_OFFSET_3]], %[[CONSTANT_5]] : i32
// CHECK:           %[[PTR_ADD_6:.*]] = ptr.ptr_add %[[PTR_ADD_5]], %[[MULI_5]] : !ptr.ptr<#ptr.generic_space>, i32
// CHECK:           %[[MULI_6:.*]] = arith.muli %[[ARG2]], %[[TYPE_OFFSET_3]] : i32
// CHECK:           %[[PTR_ADD_7:.*]] = ptr.ptr_add %[[PTR_ADD_6]], %[[MULI_6]] : !ptr.ptr<#ptr.generic_space>, i32
// CHECK:           %[[MULI_7:.*]] = arith.muli %[[TYPE_OFFSET_3]], %[[CONSTANT_6]] : i32
// CHECK:           %[[PTR_ADD_8:.*]] = ptr.ptr_add %[[PTR_ADD_7]], %[[MULI_7]] : !ptr.ptr<#ptr.generic_space>, i32
// CHECK:           %[[TYPE_OFFSET_4:.*]] = ptr.type_offset i16 : i32
// CHECK:           %[[MULI_8:.*]] = arith.muli %[[TYPE_OFFSET_4]], %[[CONSTANT_7]] : i32
// CHECK:           %[[PTR_ADD_9:.*]] = ptr.ptr_add %[[PTR_ADD_8]], %[[MULI_8]] : !ptr.ptr<#ptr.generic_space>, i32
// CHECK:           %[[MULI_9:.*]] = arith.muli %[[ARG2]], %[[TYPE_OFFSET_4]] : i32
// CHECK:           %[[PTR_ADD_10:.*]] = ptr.ptr_add %[[PTR_ADD_9]], %[[MULI_9]] : !ptr.ptr<#ptr.generic_space>, i32
// CHECK:           %[[MULI_10:.*]] = arith.muli %[[TYPE_OFFSET_4]], %[[CONSTANT_6]] : i32
// CHECK:           %[[PTR_ADD_11:.*]] = ptr.ptr_add %[[PTR_ADD_10]], %[[MULI_10]] : !ptr.ptr<#ptr.generic_space>, i32
// CHECK:           %[[FROM_PTR_0:.*]] = tptr.from_ptr %[[PTR_ADD_11]] : <#ptr.generic_space> -> memref<1xi32, #ptr.generic_space>
