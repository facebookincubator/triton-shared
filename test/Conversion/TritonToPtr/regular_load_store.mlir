...
// CHECK:           %[[FILL_0:.*]] = tensor.splat %[[UNREALIZED_CONVERSION_CAST_1]] : tensor<1024x!ptr.ptr<#ptr.generic_space>>
...
// CHECK:           %[[FILL_1:.*]] = tensor.splat %[[UNREALIZED_CONVERSION_CAST_0]] : tensor<1024x!ptr.ptr<#ptr.generic_space>>
...
// CHECK:           } -> tensor<1024x!ptr.ptr<#ptr.generic_space>>
// CHECK:           %[[GENERIC_3:.*]] = linalg.generic {indexing_maps = [#[[$ATTR_0]], #[[$ATTR_0]]], iterator_types = ["parallel"]} ins(%[[GENERIC_1]] : tensor<1024x!ptr.ptr<#ptr.generic_space>>) outs(%[[EMPTY_0]] : tensor<1024xi32>) {
// CHECK:           ^bb0(%[[VAL_7:.*]]: !ptr.ptr<#ptr.generic_space>, %[[VAL_8:.*]]: i32):
// CHECK:             %[[FROM_PTR_0:.*]] = tptr.from_ptr %[[VAL_7]] : <#ptr.generic_space> -> memref<1xi32, #ptr.generic_space>
...
// CHECK:             %[[FROM_PTR_1:.*]] = tptr.from_ptr %[[VAL_11]] : <#ptr.generic_space> -> memref<1xf32, #ptr.generic_space>
// CHECK:             memref.store %[[VAL_12]], %[[FROM_PTR_1]]{{\[}}%[[CONSTANT_0]]] : memref<1xf32, #ptr.generic_space>
// CHECK:             linalg.yield
// CHECK:           }
// CHECK:           return
// CHECK:         }